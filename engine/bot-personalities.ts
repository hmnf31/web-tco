...
const CUSTOM_PERSONALITIES: Record<string, Partial<BotPersonality>> = {
  ...
  "TeddyPlays_IG": {
    style: "dynamic",
    description: "Master adaptif yang piawai berganti strategi. Reti, Catalan, King's Indian, dan Pirc Defense dimainkan dengan fleksibilitas tinggi.",
    strengths: ["Opening kreatif", "Adaptif", "Transisi strategi mulus"],
    weaknesses: ["Kadang over-agresif", "Kurang sabar di posisi tenang"],
    openingPreference: ["Nf3", "g3", "Bg2", "c4"],
    avatarColor: "from-purple-500/20 to-pink-600/20",
    commentary: {
      praise: ["Kamu bisa menyesuaikan diri dengan sangat baik!", "Fluid sekali permainanmu!", "Kamu membaca situasi dengan tepat!"],
      neutral: ["Pertukaran yang seimbang.", "Transisi ke midgame yang solid.", "Posisi masih fleksibel."],
      mistake: ["Agak ragu-ragu, coba lebih adaptif.", "Kurang fleksibel.", "Kamu kehilangan momentum."],
      blunder: ["Blunder! Aku manfaatkan!", "Itu fatal! Aku ambil.", "Kesalahan yang mahal!"],
      opening: ["Mari lihat siapa yang lebih siap.", "Opening yang solid.", "Aku suka fleksibilitas posisimu."],
      endgame: ["Endgame! Masih banyak ruang untuk manuver.", "Ayo lihat siapa yang lebih kreatif di endgame!"],
    },
  },
  "gtempur": {
    style: "dynamic",
    description: "Pemain dinamis tangguh dengan kemampuan beradaptasi tinggi. Selalu mencari posisi nyaman di setiap fase permainan.",
    strengths: ["Adaptif", "Fleksibel", "Transisi mulus"],
    weaknesses: ["Konsistensi", "Variasi opening terbatas", "Kadang terlalu defensif"],
    openingPreference: ["e4", "d4", "Nf3"],
    avatarColor: "from-green-500/20 to-emerald-600/20",
    commentary: {
      praise: ["Adaptasimu luar biasa!", "Kamu selalu menemukan cara terbaik!", "Fleksibel sekali!"],
      neutral: ["Pertukaran rapi.", "Transisi yang baik.", "Posisi mulai terbentuk."],
      mistake: ["Kurang tepat, coba strategi lain.", "Terlalu kaku.", "Kamu kehilangan fleksibilitas."],
      blunder: ["Blunder! Kesempatanku!", "Itu mahal!", "Sayang sekali, lengah."],
      opening: ["Ayo lihat persiapan opening.", "Solid.", "Kita lihat siapa yang lebih fleksibel."],
      endgame: ["Endgame adalah rumahku!", "Ayo buktikan kemampuan adaptasimu!"],
    },
  },
  "blitzkkrieg": {
    style: "aggressive",
